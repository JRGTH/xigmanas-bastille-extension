...
import { clearDirtyState,
         refreshDir }           from './tree.js';
...
// --- DELETE ---
export async function executeDelete(filepath, fileName, liElement, isFolder = false) {
    const shortName = fileName.length > 35
        ? fileName.substring(0, 18) + '...' + fileName.substring(fileName.length - 12)
        : fileName;
